...
export default function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-background overflow-hidden px-4 py-12 sm:py-16 sm:px-6 lg:px-8">
      ...
      <div className="max-w-4xl w-full text-center space-y-8 sm:space-y-12">
        ...
        <div className="space-y-4">
          ...
          {/* Main Hero Header */}
          <h1 className="text-3xl min-[360px]:text-4xl min-[480px]:text-5xl font-black tracking-tight sm:text-7xl">
            <span className="bg-linear-to-r from-violet-600 via-indigo-600 to-cyan-500 bg-clip-text text-transparent dark:from-violet-400 dark:via-indigo-400 dark:to-cyan-400 leading-tight block pb-2">
